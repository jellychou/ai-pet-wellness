...
var Tabs = React6.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [isFocusWithinList, setIsFocusWithinList] = React6.useState(false);
  ...
  const validChildren = React6.Children.toArray(childrenProp).filter(React6.isValidElement).map((child, index) => {
  ...
  const [ListSlot, listSlotProps] = useSlot("list", {
    ...
    getSlotProps: (handlers) => ({
      ...
      onBlur: (event) => {
        var _a;
        if (!contains_default(event.currentTarget, event.relatedTarget)) {
  ...
  return (0, import_jsx_runtime7.jsxs)(RootSlot, {
    ...
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime7.jsxs)(ScrollerSlot, {
      ...
      children: [(0, import_jsx_runtime7.jsx)(ListSlot, {
        ...
        role: "tablist",
        ...listSlotProps,
        children: (0, import_jsx_runtime7.jsx)(RovingTabIndexContext.Provider, {
