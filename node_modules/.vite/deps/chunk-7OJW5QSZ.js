...
function useFormControlState({
  ...
  const muiFormControl = React3.useContext(FormControlContext_default);
  const result = {};
...
true ? InitColorSchemeScript2.propTypes = {
   ...
   */
  attribute: import_prop_types3.default.string,
  /**
   * The node (provided as string) used to attach the color-scheme attribute.
   * @default 'document.documentElement'
   */
  colorSchemeNode: import_prop_types3.default.string,
  /**
   * localStorage key used to store `colorScheme`.
   * @default 'mui-color-scheme'
   */
  colorSchemeStorageKey: import_prop_types3.default.string,
  /**
   * The default color scheme to be used in dark mode.
   * @default 'dark'
   */
  defaultDarkColorScheme: import_prop_types3.default.string,
  /**
   * The default color scheme to be used in light mode.
   * @default 'light'
   */
  defaultLightColorScheme: import_prop_types3.default.string,
  /**
   * The default mode when the storage is empty (user's first visit).
   * @default 'system'
   */
  defaultMode: import_prop_types3.default.oneOf(["dark", "light", "system"]),
  /**
   * localStorage key used to store `mode`.
   * @default 'mui-mode'
   */
  modeStorageKey: import_prop_types3.default.string,
  /**
...
function ThemeProvider({
  ...
  const noVarsTheme = React6.useMemo(() => {
...
//# sourceMappingURL=chunk-7OJW5QSZ.js.map
