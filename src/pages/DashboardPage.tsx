...
const earPhoto =
  "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=360&h=280&fit=crop";
...
export function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-3">
      ...
      <footer className="flex items-center justify-between rounded-xl bg-mist px-5 py-2 text-[12px] text-[#78A4CB]">
        <span>🐾 Food・Heart — 陪伴毛孩，也陪伴你 ♡</span>
